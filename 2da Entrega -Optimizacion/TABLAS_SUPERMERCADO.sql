...
CREATE TABLE Cliente(
	...
	UNIQUE (CLIENTE_DNI,CLIENTE_MAIL)
);

CREATE TABLE Marca(
	MARCA_ID BIGINT PRIMARY KEY,
	MARCA_NOMBRE NVARCHAR(255),
	MARCA_DESCRIPCION NVARCHAR(255)
);

CREATE TABLE Subcategoria(
	SUBCATEGORIA_ID BIGINT PRIMARY KEY,
...
CREATE TABLE Categoria(
	 ...
	 SUBCATEGORIA_ID BIGINT FOREIGN KEY REFERENCES Subcategoria(SUBCATEGORIA_ID),
...
CREATE TABLE Producto (
	...
	MARCA_ID BIGINT FOREIGN KEY REFERENCES Marca(MARCA_ID),     
	CATEGORIA_ID BIGINT FOREIGN KEY REFERENCES Categoria(CATEGORIA_ID), 
...
CREATE TABLE DetalleTicket (
    ...
    PRODUCTO_ID BIGINT FOREIGN KEY REFERENCES Producto(PRODUCTO_ID),
    CANTIDAD INT,
